...
export default function Logo({ size = 40, color = "var(--primary)", className, ...props }: LogoProps) {
  return (
    <svg
    ...
    >
      <g id="logomark">
        ...
        {/* inner hole filled white so it appears as a white background */}
        <path d="M22 4C13.1634 4 6 11.1634 6 20C6 28.8366 13.1634 36 22 36C30.8366 36 38 28.8366 38 20C38 11.1634 30.8366 4 22 4Z" fill="#ffffff" />

        <path d="M36 20C36 25.5228 31.5228 30 26 30C20.4772 30 16 25.5228 16 20C16 14.4772 20.4772 10 26 10C31.5228 10 36 14.4772 36 20Z" fill="currentColor" />
      </g>
    </svg>
  )
}
